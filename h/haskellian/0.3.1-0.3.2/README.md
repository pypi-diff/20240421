# Comparing `tmp/haskellian-0.3.1.tar.gz` & `tmp/haskellian-0.3.2.tar.gz`
...
### Comparing `haskellian-0.3.1/src/haskellian.egg-info/PKG-INFO` & `haskellian-0.3.2/src/haskellian.egg-info/PKG-INFO`
