# Comparing `tmp/msscrawler-1.3.4.tar.gz` & `tmp/msscrawler-1.3.5.tar.gz`
...
### Comparing `msscrawler-1.3.4/src/msscrawler/generic_crawler.py` & `msscrawler-1.3.5/src/msscrawler/generic_crawler.py`
