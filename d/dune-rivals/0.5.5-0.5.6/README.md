# Comparing `tmp/dune_rivals-0.5.5.tar.gz` & `tmp/dune_rivals-0.5.6.tar.gz`
...
## Comparing `dune_rivals-0.5.5.tar` & `dune_rivals-0.5.6.tar`
...
### Comparing `dune_rivals-0.5.5/dune_rivals.py` & `dune_rivals-0.5.6/dune_rivals.py`
